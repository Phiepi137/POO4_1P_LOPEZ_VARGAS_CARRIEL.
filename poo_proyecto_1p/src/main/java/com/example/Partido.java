...
public class Partido{
    ...
    // constructor
    public Partido(String codigo, String seleccionLocal, String seleccionVisitante, LocalDate fecha, String estadio, String ciudad, int capacidad, FasePartido fase, ArrayList<Zona> zonas){
